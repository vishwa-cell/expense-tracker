...
def generate_graph(data):
     fig=px.bar(data, x='months',y='expense',title='Monthly Expenses')
     fig.update_layout(
...
class ExpenseListView(FormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        aggregated_data =[{'year_month':key, 'expense':sum(item['amount'] for item in value)} for key,value in expense_data_graph.items()]  
        ...
        graph_data = {
             ...
             'expense':[item['expense']for item in aggregated_data]
        }      
